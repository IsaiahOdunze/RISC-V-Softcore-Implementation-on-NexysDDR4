...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set en_led_0 [ create_bd_port -dir O en_led_0 ]
  set enable_0 [ create_bd_port -dir I enable_0 ]
  set led_en_0 [ create_bd_port -dir O -from 2 -to 0 led_en_0 ]
  set reset [ create_bd_port -dir I -type rst reset ]
  set_property -dict [ list \
   CONFIG.POLARITY {ACTIVE_LOW} \
 ] $reset
  set sw_in_0 [ create_bd_port -dir I -from 2 -to 0 sw_in_0 ]
  ...
  # Create instance: leds_fsm_0, and set properties
  set block_name leds_fsm
  set block_cell_name leds_fsm_0
  if { [catch {set leds_fsm_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $leds_fsm_0 eq "" } {
  ...
  # Create port connections
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins mig_7series_0/clk_ref_i] [get_bd_pins mig_7series_0/sys_clk_i]
  connect_bd_net -net clk_wiz_0_locked [get_bd_pins clk_wiz_0/locked] [get_bd_pins mig_7series_0/sys_rst]
  connect_bd_net -net enable_0_1 [get_bd_ports enable_0] [get_bd_pins ila_0/probe0] [get_bd_pins leds_fsm_0/enable]
  connect_bd_net -net leds_fsm_0_en_led [get_bd_ports en_led_0] [get_bd_pins ila_0/probe2] [get_bd_pins leds_fsm_0/en_led]
  connect_bd_net -net leds_fsm_0_led_en [get_bd_ports led_en_0] [get_bd_pins axi_gpio_0/gpio2_io_i] [get_bd_pins ila_0/probe3] [get_bd_pins leds_fsm_0/led_en]
  ...
  connect_bd_net -net microblaze_0_Clk [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_uartlite_0/s_axi_aclk] [get_bd_pins microblaze_0/Clk] [get_bd_pins microblaze_0_axi_periph/ACLK] [get_bd_pins microblaze_0_axi_periph/M00_ACLK] [get_bd_pins microblaze_0_axi_periph/M01_ACLK] [get_bd_pins microblaze_0_axi_periph/S00_ACLK] [get_bd_pins microblaze_0_axi_periph/S01_ACLK] [get_bd_pins microblaze_0_local_memory/LMB_Clk] [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins rst_mig_7series_0_81M/slowest_sync_clk]
  ...
  connect_bd_net -net rst_mig_7series_0_81M_peripheral_aresetn [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/ARESETN] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins microblaze_0_axi_periph/S01_ARESETN] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins rst_mig_7series_0_81M/peripheral_aresetn]
  connect_bd_net -net sw_in_0_1 [get_bd_ports sw_in_0] [get_bd_pins axi_gpio_0/gpio_io_i] [get_bd_pins ila_0/probe1] [get_bd_pins leds_fsm_0/sw_in]
  connect_bd_net -net sys_clock_1 [get_bd_ports sys_clock] [get_bd_pins clk_wiz_0/clk_in1] [get_bd_pins ila_0/clk] [get_bd_pins leds_fsm_0/clock]
